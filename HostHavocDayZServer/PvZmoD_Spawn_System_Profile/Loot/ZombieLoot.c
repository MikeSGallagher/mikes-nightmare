...
ref autoptr TStringArray itemList_04 	= {"0.3","Pristine","Lockpick","Potato","Potato","Potato","Potato","Potato","ChernarusMap","Rope",};
...
ref autoptr TStringArray itemList_05 	= {"0.4","Pristine","LeatherSewingKit","Megaphone","Rag","Rag","Rag","Rag","FirefighterAxe",}; 
...
ref autoptr TStringArray zombieList_24 	= {"ZmbM_Mummy",}; 
ref autoptr TStringArray itemList_24 	= {"20.0","Pristine","Guts","HumanSteakMeat","Bone",};
